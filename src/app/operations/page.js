        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <p className="text-gray-600">จัดการ applications
                    <a href="https://itportal-pm.jventures.co.th/" target="_blank" className="flex items-center text-gray-700 hover:text-red-600 transition-colors group">
                    ...
                    <a href="https://dopalog-itcheck.jfin.network/" target="_blank" className="flex items-center text-gray-700 hover:text-red-600 transition-colors group">
                        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        <span className="font-medium">Dopa log</span>
                    </a>
                    <a href="https://front-services-otp.jfin.network/admin/sms-dashboard" target="_blank" className="flex items-center text-gray-700 hover:text-red-600 transition-colors group">
                        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        <span className="font-medium">OTP/SMS Dashboard</span>
                    </a>
                    <a href="https://ekyc-backoffice-v2.jfin.network/login" target="_blank" className="flex items-center text-gray-700 hover:text-red-600 transition-colors group">
                        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        <span className="font-medium">EKYC-prod admin Dashboard</span>
                    </a>
                    <a href="https://ekyc-backoffice-uat-v2.jfin.network/login" target="_blank" className="flex items-center text-gray-700 hover:text-red-600 transition-colors group">
                        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        <span className="font-medium">EKYC-non-prod admin Dashboard</span>
                    </a>
                </p>
            </div>
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-red-50 rounded-lg p-4 border border-red-100">
                                    <ul className="space-y-3">
                                        ...
                                        <li>
                                            <a href="/operations/aws/prod/createec2" className="flex items-center text-gray-700 hover:text-red-600 transition-colors group">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-green-50 rounded-lg p-4 border border-green-100">
                                    <ul className="space-y-3">
                                        ...
                                        <li>
                                            <Link href="/operations/aws/nonprod/check-security-patch" className="flex items-center text-gray-700 hover:text-green-600 transition-colors group">
                                                <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                                <span className="font-medium">Check Security Patch</span>
                                            </Link>
                                        </li>
                                        <li>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-2 mb-2">
                                    <span className="w-3 h-3 rounded-full bg-green-500"></span>
                                    <h3 className="font-bold text-lg text-gray-900">Both Prod and Non-prod</h3>
                                </div>
                                <div className="bg-blue-50 rounded-lg p-4 border border-purple-100">
                                    <ul className="space-y-3">
                                        ...
                                        <li>
                                            <Link href="/operations/aws/ec2-by-tag" className="flex items-center text-gray-700 hover:text-green-600 transition-colors group">
                                                <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                                                <span className="font-medium">List EC2 Instances by Tagged</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
                ...
                {activeTab === 'byteplus' && (
                    <div className="space-y-4">
                        ...
                        <div className="p-4 bg-gray-50 border border-gray-100 rounded-lg">
                            ...
                            <Link
                                href="/operations/byteplus/map-url"
                                className="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium !text-white hover:bg-blue-700"
                            >
                                Open Map URL Form
                            </Link>
                        ...
                        <div className="p-4 bg-gray-50 border border-gray-100 rounded-lg">
                            <h3 className="font-semibold text-gray-800 mb-2">Edit URL to Endpoint</h3>
                            <p className="text-sm text-gray-600 mb-3">ค้นหาด้วย FQDN เพื่อแก้ไขหรือลบ route/service</p>
                            <Link
                                href="/operations/byteplus/edit-map-url"
                                className="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium !text-white hover:bg-blue-700"
                            >
                                Open Edit URL Form
                            </Link>
