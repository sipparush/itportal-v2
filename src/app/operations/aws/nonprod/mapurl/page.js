...
export default function MapUrlPage() {
    ...
    const handleAddUrlToCf = async () => {
        ...
        try {
            const response = await fetch('/api/operations/aws/nonprod/managecf', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="col-span-2 space-y-3">
                            <Link target="_blank" href="https://kong-ui-uat.jfin.network/services" className="text-blue-600 hover:underline">
