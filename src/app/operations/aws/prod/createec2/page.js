...
export default function CreateEC2ProdPage() {
    ...
    const handleCreateInstance = async () => {
        ...
        setResult(null);
        try {
            const response = await fetch('/api/operations/aws/prod/createec2', {
                method: 'POST',
    ...
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold mb-4">Create EC2 Instance on AWS-Prod</h1>
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    placeholder="e.g. prod-portal-core"
                />
            </div>
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    className="border p-2 w-full"
                    placeholder="e.g. prod-portal-api-01"
                />
            </div>
