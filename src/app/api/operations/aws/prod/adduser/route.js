...
const SCRIPT_CANDIDATE_PATHS = [
    process.env.AWS_PROD_ADDUSER_SCRIPT_PATH,
    '/app/scripts/aws/prod/adduser/adduservendor.sh',
    path.resolve('./src/app/api/operations/aws/prod/adduser/script/adduservendor.sh')
].filter(Boolean);
